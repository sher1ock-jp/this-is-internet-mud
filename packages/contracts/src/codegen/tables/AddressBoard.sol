...
ResourceId constant _tableId = ResourceId.wrap(
  bytes32(abi.encodePacked(RESOURCE_TABLE, bytes14(""), bytes16("AddressBoard")))
);
ResourceId constant AddressBoardTableId = _tableId;

FieldLayout constant _fieldLayout = FieldLayout.wrap(
  0x0020010020000000000000000000000000000000000000000000000000000000
);

library AddressBoard {
  /**
   ...
   */
  function encodeStatic(bytes32 chat) internal pure returns (bytes memory) {
    return abi.encodePacked(chat);
  }
   ...
   */
  function encode(bytes32 chat) internal pure returns (bytes memory, PackedCounter, bytes memory) {
    bytes memory _staticData = encodeStatic(chat);
